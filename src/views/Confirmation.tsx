...
import { useState, useEffect } from 'react'; //React has been removed from this so the ts compiles
    ...
    <div className="flex flex-col gap-y-10 items-center pb-10 bg-kindly-offWhite">
      ...
      {visible && (
        <div
          ...
          } transition-opacity duration-500 -mt-10`}
        >
          <div
            className="bg-green-100 border border-green-400 text-green-700 px-12 py-3 rounded relative text-center"
            role="alert"
          >
            <strong className="font-bold ">Success!</strong>
            <span className="block sm:inline">
              You Completed the task to send your mom a video message telling
              her that you love her and appreciate her
            </span>
          </div>
        </div>
      )}
