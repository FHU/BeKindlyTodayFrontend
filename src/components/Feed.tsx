...
const Feed = ({ completion }: Props) => {
  ...
  return (
    <div className="w-22rem pl-6 sm:w-96 sm:pl-1 sm:overflow-x-hidden">
      <div className="chat chat-start bg-kindly-offWhite">
        {/* avatar image */}
        <div className="chat-image avatar">
          <div className="w-14 sm:w-12 rounded-full">
            <img
        ...
        {/* chat bubble */}
        <div
          className="chat-bubble sm:w-5/6 shadow-md bg-white text-black"
        >
